...
VISION_RMS_NORM_EPS = 1e-6  # fabric reuses the text config's rms_norm_eps for vision
...
def main():
    ...
    writer.add_uint32("groot.position_embed_max_len", POSITION_EMBED_MAX_LEN)
    ...
    writer.add_float32("groot.vision.rms_norm_eps", VISION_RMS_NORM_EPS)
